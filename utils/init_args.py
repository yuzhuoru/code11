...
def init_args(env, **args):
    ...
    print("limit torch intra-op parallel threads num to {num} for saving computing resource.".format(num=1))
    ...
    if (
        ...
        raise NotImplementedError('Do not support discrete action space! ')
